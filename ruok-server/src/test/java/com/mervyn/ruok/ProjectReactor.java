...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.mervyn";
    private static final String ARTIFACT_ID = "ruok";
    private static final String PACKAGE_NAME = "com.mervyn.ruok";
    private static final String TITLE = "RUOK管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.mervyn";
        String artifactIdNew = "ruok";
        String packageNameNew = "com.mervyn.ruok";
        String titleNew = "RUOK管理系统";
        String projectBaseDirNew = "/Users/2hen9ao/workspace/2024/ruok"; // 一键改名后，“新”项目所在的目录
