...
import com.mervyn.ruok.framework.tracer.core.aop.BizTraceAspect;
import com.mervyn.ruok.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ruok.tracer", value = "enable", matchIfMissing = true)
public class RuokTracerAutoConfiguration {
