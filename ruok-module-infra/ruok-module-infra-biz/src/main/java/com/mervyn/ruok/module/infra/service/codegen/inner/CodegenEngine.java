package com.mervyn.ruok.module.infra.service.codegen.inner;
...
import com.mervyn.ruok.framework.apilog.core.enums.OperateTypeEnum;
...
import com.mervyn.ruok.framework.common.util.date.LocalDateTimeUtils;
import com.mervyn.ruok.framework.common.util.object.BeanUtils;
import com.mervyn.ruok.framework.common.util.object.ObjectUtils;
import com.mervyn.ruok.framework.common.util.string.StrUtils;
import com.mervyn.ruok.framework.excel.core.annotations.DictFormat;
import com.mervyn.ruok.framework.excel.core.convert.DictConvert;
...
import com.mervyn.ruok.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ruok-module-${table.moduleName}/" + // 顶级模块
                "ruok-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ruok-module-${table.moduleName}/" + // 顶级模块
                "ruok-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ruok-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ruok-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
